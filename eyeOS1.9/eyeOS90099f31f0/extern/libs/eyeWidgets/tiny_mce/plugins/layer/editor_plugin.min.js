...
"")a.style.top="20px";if(a.style.width=="")a.style.width=a.width?a.width+"px":"100px";if(a.style.height=="")a.style.height=a.height?a.height+"px":"100px";a.style.position="absolute";b.addVisual(b.getBody())}b.execCommand("mceRepaint");b.nodeChanged()}}});tinymce.PluginManager.add("layer",tinymce.plugins.Layer)})();
