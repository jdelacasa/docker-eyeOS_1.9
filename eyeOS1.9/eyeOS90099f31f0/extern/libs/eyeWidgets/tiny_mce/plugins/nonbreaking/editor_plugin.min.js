(function(){tinymce.create("tinymce.plugins.Nonbreaking",{init:function(a){this.editor=a;a.addCommand("mceNonBreaking",function(){a.execCommand("mceInsertContent",false,a.plugins.visualchars&&a.plugins.visualchars.state?'<span class="mceItemHidden mceVisualNbsp">&middot;</span>':"&nbsp;")});a.addButton("nonbreaking",{title:"nonbreaking.nonbreaking_desc",cmd:"mceNonBreaking"});a.getParam("nonbreaking_force_tab")&&a.onKeyDown.add(function(b,c){if(tinymce.isIE&&c.keyCode==9){b.execCommand("mceNonBreaking");
