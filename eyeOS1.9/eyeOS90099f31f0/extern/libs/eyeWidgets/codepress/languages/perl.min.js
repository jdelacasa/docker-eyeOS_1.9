...
output:"<b>$1</b>"},{input:/([\(\){}])/g,output:"<u>$1</u>"},{input:/#(.*?)(<br>|<\/P>)/g,output:"<i>#$1</i>$2"}];Language.snippets=[];Language.complete=[{input:"'",output:"'$0'"},{input:'"',output:'"$0"'},{input:"(",output:"($0)"},{input:"[",output:"[$0]"},{input:"{",output:"{\n\t$0\n}"}];Language.shortcuts=[];
